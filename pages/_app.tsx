      ...
      >
        <div className="xl:w-[1200px] m-auto overflow-hidden h-[100vh]">
          ...
          <div className="flex gap-6 md:gap-20">
            ...
            <div className="mt-0 md:mt-4 flex flex-col gap-4 md:gap-10 snap-y snap-mandatory snap-always h-[100vh] overflow-y-scroll  overflow-x-hidden videos">
          ...
          <div className="fixed bottom-0 w-full cursor-pointer block md:hidden z-50">
            ...
            ></div> */}
            <div className="h-[3rem] sd:block bg-black border-t-2 border-gray-100 text-gray-200 font-small">
              <MainFooter />
            </div>
          </div>
        </div>
