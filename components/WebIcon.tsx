              ...
              <>
                <div className="gap-6">
                  <div className="mt-4 flex flex-col justify-center items-center cursor-pointer">
                    ...
                    <p
                      className={`text-lg text-gray-900 font-semibold ${post?.hearts >= 10 ? "pl-0" : "pl-1"
                        }`}
                    >
                      {checkNumberValue(post?.hearts || 0)}
                    </p>
                  </div>
                </div>
              </>
              ...
              <Link href={`/detail/${post.id}`}>
                <a>
                  <div className="flex flex-col justify-center items-center cursor-pointer">
                    ...
                    <p
                      className={`text-lg text-gray-900 font-semibold ${comments?.hearts >= 10 ? "pl-0" : "pl-1"
                        }`}
                    >
              ...
              <>
                <div className="gap-6">
                  <div className="flex flex-col justify-center items-center cursor-pointer">
                    ...
                    <p
                      className={`text-lg text-gray-900 mb-3 font-semibold ${comments?.hearts >= 10 ? "pl-0" : "pl-1"
                        }`}
                    >
                      {checkNumberValue(comments?.length || 0)}
                    </p>
              ...
              <>
                <div className="gap-6">
                  <div className="flex flex-col justify-center items-center cursor-pointer">
                    ...
                    <p
                      className={`text-lg text-gray-900 mb-3 font-semibold ${post?.hearts >= 100 ? "pl-1" : "pl-1"
                        }`}
                    >
                      {checkNumberValue(post?.shares || 0)}
                    </p>
                  </div>
                </div>
              </>
